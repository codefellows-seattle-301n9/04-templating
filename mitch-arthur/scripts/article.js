...
Article.prototype.toHtml = function() {
  ...
  let templateRender = Handlebars.compile($('#articles-template').html());
  ...
  // if(this.publishedOn) {
    ...
    // Because a and b are two different parameters rather than one.  They need to be enclosed in parentheses.
rawData.sort((a,b) => {
