...
Article.prototype.toHtml = function() {
  ...
  let blogTemplate = $('#blog-template').html();
  let blogTemplateRender = Handlebars.compile(blogTemplate);
  ...
  return blogTemplateRender(this);
};

// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// For a and b two arguments are being passed, you can only remove parentheses for one argument that is being passed.
rawData.sort((a,b) => {
