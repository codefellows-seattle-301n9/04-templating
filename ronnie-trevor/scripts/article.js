...
Article.prototype.toHtml = function() {
  ...
  let blogTemplate = $('#article-template').html();
  let templateRender = Handlebars.compile(blogTemplate);
...
// You have to use parentheses when there are multiple parameters or arguements.
rawData.sort((a,b) => {
